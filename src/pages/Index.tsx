...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      {getSetting('show_stats_section', 'true') === 'true' && (
        <section className="border-b border-border bg-card">
          <motion.div 
            ...
            className="container grid grid-cols-3 divide-x divide-border overflow-hidden"
          >
            {dynamicStats.map((s) => (
              <motion.button 
                variants={{
      ...
      {/* Categories */}
      {getSetting('show_categories_preview', 'true') === 'true' && (
      ...
      {getSetting('show_dynamic_cta', 'true') === 'true' && (
        <section className="py-20">
          <div className="container">
